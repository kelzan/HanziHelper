...
/**
 * This class was taken from public domain
 * (http://java.sun.com/docs/books/tutorial/uiswing/components/table.html) and slightly modified to
 * work here. All comments are preserved below. Credit should be given to the original authors.
 *
...
public class TableSorter extends AbstractTableModel {
    ...
    private Comparator numberComp = new Comparator() {
        public int compare(Object o, Object o1) {
            int a = Integer.parseInt(o.toString());
            int b = Integer.parseInt(o1.toString());
            return a - b;
        }
    };
